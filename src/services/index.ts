...
export function registerServices(app: Application) {
  app.use('/apm/users', new UsersService(UsersOptions(app)));
  ...
  app.use('/apm/canvassing-reports', new CanvassingReportsService(CanvassingReportsOptions(app)), { methods: CUSTOM_CANVASSING_METHODS });
  ...
  app.use('/apm/incidents', new IncidentsService(IncidentsOptions(app)), { methods: CUSTOM_INCIDENT_METHODS });
  ...
  app.use('/apm/election-results', new ElectionResultsService(ElectionResultsOptions(app)), { methods: CUSTOM_ELECTION_METHODS });
